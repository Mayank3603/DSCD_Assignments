...
class YoutubeServer:
    ...
    def subscribe_user(self, username, youtuber_name):
        ...
        if youtuber_name not in self.subscriptions:
            self.subscriptions[youtuber_name] = []
        self.subscriptions[youtuber_name].append(username)
    ...
    def unsubscribe_user(self, username, youtuber_name):
        ...
        if youtuber_name in self.subscriptions:
            self.subscriptions[youtuber_name] = [user for user in self.subscriptions[youtuber_name] if user != username]
